                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700"
                                ...
                                <td class="flex mt-8">
                                    ...
                                    <button class="btn btn-red p-2"
                                        wire:click="$dispatch('deleteProd',{{ $product->id }})">
    ...
    <x-dialog-modal wire:model.live="open">
        ...
        @slot('content')
            ...
            <div class="py-3">
                ...
                <select class="form-control w-full" wire:model='form.provider_id'>
            ...
            <div class="py-3">
                ...
                <select class="form-control w-full" wire:model='form.category_id'>
